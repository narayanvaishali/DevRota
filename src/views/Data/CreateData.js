...
class CreateData extends Component {
  ...
  handleSave() {
    const dbCon = database.ref('/schedules');
    const { data: sch } = this.state;
    let dt = {};
  ...
  // 'this' is to be used by classes handler
  handleUsers() { // eslint-disable-line
    const dbCon = database.ref('/users');
    dbCon.push({ Asad: 'AI' });
